...
import {
  Globe, MapPin, ListTodo, Eye, Edit, Trash2, Flag, UserPlus,
  Sun, Sunset, Moon, Clock, ChevronUp, ChevronDown
} from 'lucide-react'
...
interface PostCardProps {
  ...
  token?: string
  onViewItinerary?: (post: any) => void
  onProposeTrip?: (post: any) => void
    ...
    <Card className="overflow-hidden">
      ...
      {post.mediaUrls && post.mediaUrls.length > 0 && (
        <div className={`grid gap-1 ${
          ...
          {post.mediaUrls.slice(0, 5).map((url: string, idx: number) => (
            <div
              key={idx}
            ...
            {itineraryExpanded && (
              <div className="mt-3 space-y-3">
                ...
                <div className="space-y-2">
                  {post.itinerarySnapshot.days?.map((day: any) => (
