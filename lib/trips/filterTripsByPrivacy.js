 ...
 * 
 * IMPORTANT: This function filters based on the TRIP OWNER's privacy, not the viewer's privacy.
 * The viewer's own privacy setting should NEVER prevent them from seeing their own trips.
 * 
...
export async function filterTripsByPrivacy(db, trips, viewerId) {
  ...
  return trips.filter(trip => {
    // CRITICAL: Always allow if viewer is the trip owner
    // The viewer's own privacy setting does NOT affect what they see for themselves
